...
void exibirMenu(int x, int y){//Exibir os menus a depender da coordenada
    ...
    case 1:
        ...
        case 0:
            ...
            printf("| 3-CADASTRO DE TURMAS                      |\n");
            printf("| 4-CADASTRO DE ALUNOS NAS TURMAS           |\n");
            printf("| 5-CADASTRO DOS DOCENTES                   |\n");
    ...
    case 2:
        ...
        case 0:
            ...
            printf("| 6-CONSULTAR RELATÓRIOS DIVERSOS           |\n");
            printf("| 7-VOLTAR AO MENU PRINCIPAL                |\n");
            printf("|                                           |\n");
            printf("|___________________________________________|\n");
            break;
        case 6:
            printf("| MENU CONSULTAR RELATÓRIOS DIVERSOS        |\n");
            printf("| 1-CONSULTAR RELATÓRIO DE ALUNOS           |\n");
            printf("| MATRICULADOS                              |\n");
            printf("| 2-CONSULTAR ALUNOS POR TURMAS             |\n");
            printf("| 3-CADASTRADOS NO PROCESSO SELETIVO        |\n");
            printf("| 4-NOTAS POR ALUNOS INDIVIDUAIS            |\n");
            printf("| 5-NOTAS DOS ALUNOS POR TURMA              |\n");
